 ...
 * Modified and Generated by KangDroid-Project
 *
...
public class KangDroidInfoSettings extends SettingsPreferenceFragment {
	private static final String LOG_TAG = "KangDroidInfoSettings";
	...
	public void onCreate(Bundle icicle) {
		...
		addPreferencesFromResource(R.xml.kangdroid_info_settings);
		
		setValueSummary(KEY_KDP_VERSION, "ro.kdp.version");
		findPreference(KEY_KDP_VERSION).setEnabled(true);
